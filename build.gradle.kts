...
// This configuration-time installer is idempotent (verifies required package
// dirs, not just the marker) and always writes local.properties to this
// repo's own .android-sdk path. There is no fallback to a sibling repo's SDK.
