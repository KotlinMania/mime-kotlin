...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Mime.swiftmodule/`
...
//      `import Mime` above would fail at compile time.
//
//   2. The static archive `libMime.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Mime" }` and
//      `flattenPackage = "io.github.kotlinmania.mime"` configuration in
...
final class MimeExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Mime swift module imported cleanly")
    }
}
